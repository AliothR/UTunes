...
Page({
  ...
  results: {
    L1: [
      ...
      'XX同学经常对下课铃声充耳不闻，因为TA总是把这声音和教室外施工的声音混淆。'
    ],
    L2: [
    ...
    L3: [
      'XX同学从不在意是不是别人跑调，宽容的TA总能欣赏别人的歌喉。',
      'XX同学的音高感还算不错，TA能准确分辨出落在地上的硬币是一毛而不是一块。',
    ...
    L5: [
      'XX同学耳力不错，通过敲击西瓜，TA可以挑选出熟得最好的那一个。',
      'XX引以为傲的特异功能——根据脚步声判断体重。',
      'XX同学耳朵非常棒，TA知道自己鼠标左键和右键按下的声音有着细微的差别。'
    ],
    L6: [
      '对于听力超凡的XX来说，即使闭着眼睛往暖壶灌水都不会漫出来。',
      'XX的听力非常好，TA甚至能从对方声音的嘶哑程度听出TA昨天吃的麻辣烫是什么辣度！',
      '有着超凡的耳力的XX同学，听得出楼下那个拉小提琴的同学，每天都在进步一点点。'
    ],
    L7: [
      'XX的耳力了得，可以说是很有音乐天赋了，不考虑一下合唱团吗？',
      'XX同学耳朵非常厉害，如果学习乐器的话，是可以凭借耳朵调音的呢！',
      '如果不是学习成绩足够好，XX同学应该去音乐学院才对。',
      '睡梦中的沈亦青被蚊子的嗡嗡声吵醒，她皱了皱眉“可恶，和刚才的不是同一只。”'
    ],
    L8: [
